...
\usepackage{xcolor}
\usepackage{booktabs}
\usepackage{multirow}     % necesario para tablas con celdas que abarcan varias filas
\usepackage{algorithm}
\usepackage{algpseudocode}
\usepackage{tikz}
\usetikzlibrary{positioning,decorations.pathreplacing,arrows,arrows.meta,babel,shapes.multipart,fit,backgrounds}
\usepackage{amsmath}
\usepackage{amsthm}
\usepackage{graphicx}
...
\usepackage{fancyhdr}
\usepackage{graphicx}
\usepackage{changepage}   % \checkoddpage / \ifoddpage para centrar figuras anchas en la pagina
\strictpagecheck
\newsavebox{\arqbox}      % caja para capturar la figura de arquitectura antes de escalarla
                          % (evita el choque de \resizebox con los caracteres activos de babel spanish)
...
% ********************************************************************
%\newcommand{\myTitle}{Análisis Comparativo de Rendimiento entre ECC y RSA en Entornos Deterministas\xspace}
...
%\input{capitulos/03_Cuantica}
\input{capitulos/03_Campos_Finitos}


\part{Marco Teórico}
\input{capitulos/04_Curvas_Elipticas}
\input{capitulos/05_Criptografia_Curvas_Elipticas}
