\begin{titlepage}
  ...
  \noindent\hspace*{\centeroffset}\begin{minipage}{\textwidth}
    ...
    {\large\bfseries Un estudio sobre la eficiencia algorítmica en Criptografía de Curvas Elípticas frente a esquemas de factorización entera con una implementación de alta precisión con NTL}
  \end{minipage}
