...
Un ejemplo de ello es el cifrado de \hyperlink{vernam-ref}{\textcolor{black}{\fcolorbox{green}{white}{Vernam}}}~\citep{vernam}, definido sobre $A = \{0, 1\}$. Dado un mensaje binario $m_1m_2\ldots m_t$ y una clave binaria $k_1k_2\ldots k_t$ de la misma longitud, el texto cifrado es:
