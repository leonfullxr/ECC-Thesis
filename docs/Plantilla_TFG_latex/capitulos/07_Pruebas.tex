...
Para situar los resultados en perspectiva, se compararon los tiempos de la implementación propia con los de OpenSSL~3.0.2, una biblioteca de producción ampliamente utilizada. La comparación se realizó en la misma máquina mediante la utilidad \texttt{openssl speed}, con una duración de 50~segundos por operación. El cuadro~\ref{tab:res-openssl} recoge los resultados.
