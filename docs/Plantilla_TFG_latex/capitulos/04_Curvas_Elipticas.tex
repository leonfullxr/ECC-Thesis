...
La idea geométrica es sencilla y constituye el corazón de toda la aritmética de curva, por lo que conviene entenderla bien:, porque es la operación 
...
al que llamamos \(R'\) que el resultado de la suma se define como el reflejo de \(R'\) respecto al eje de simetría de la curva 
