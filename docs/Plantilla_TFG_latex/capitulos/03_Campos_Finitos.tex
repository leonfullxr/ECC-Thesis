...
\begin{enumerate}
  ...
  \item \emph{Constrain hardware}: en dispositivos con ALU reducida puede convenir \(\mathbb{F}_{2^m}\) o OEF para evitar multiplicadores de enteros avanzados~\citep{militzer2004oef}.
\end{enumerate}
